...
//
// 2017 Oct. Add Distance and auto refresh Text by F4GMU
// ------------------------------
...
const int RGB_GREEN_PIN = 1;
const int RGB_BLUE_PIN = 2;
...
//Inputs
String origin = "Lyon,+France";
String destination = "Reims,+France";
String displayText = "Lyon -> Reims";
float limit = 10.0;
...
void displayTraffic() {
  ...
  display.drawString(0, 0, String((origin) + "->" + (destination))); //Auto refresh Text
  ...
  /*Adding distance in ligne 4*/
  display.drawString(0, 45, "Distance: " + distance);
  display.display();
}
